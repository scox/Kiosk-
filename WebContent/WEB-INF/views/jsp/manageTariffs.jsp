...
<table cellpadding="0" cellspacing="0" border="0">
				<tr valign="top">
					...
					<li class="selected"><a href="manageTariffs.htm?type=getAdd"">Add Tariff</a></li>
...
function onInvokeAction(id) {   
	...
	location.href = '${pageContext.request.contextPath}/manageAudios.htm?type=getpage&' + parameterString;
...
<c:if test="${(type) == 'getAdd'}">
	<form action = "manageTariffs.htm" name = "tariffForm" onsubmit="return (ValData())">
