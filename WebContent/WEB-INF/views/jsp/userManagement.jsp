...
<c:if test="${(option) == 'getAddUser' || (option) == 'doAddUser' }">
						...
						<form action="userManagement.htm" name="addForm"
							...
							<table>
								<tr>
									<td>Username</td>
									<td><input type="text" id = "username" name="username" maxlength ="20" />
									</td>
								</tr>
								<tr>
									<td>Password</td>
									<td><input type="text" id = "password" name="password" maxlength = "20" />
									</td>
						...
						<c:if test="${(option) == 'getDeleteUser' || (option) == 'doDeleteUser' }">
...
<c:forEach items="${users}" var="users" varStatus="status">
   <option value="<c:out value="${users.userID}" />"><c:out value="${users.username}" /></option>
	...
	<c:if test="${(option) == 'doEditAccess' || (option) == 'getEditAccess' }">
...
<c:forEach items="${users}" var="users" varStatus="status">
   <option value="<c:out value="${users.userID}" />"><c:out value="${users.username}" />(<c:out value="${users.accessRight}" />)</option>
	...
	<c:if test="${(option) == 'doChangePassword' || (option) == 'getChangePassword' }">

						<form action="userManagement.htm" name="editForm"
							onsubmit="return (ValChangePW())">
							<input type="hidden" name="option" value="doChangePassword" />
							<input type="hidden" name="userID" value="<c:out value="${user.userID}" />" />
							<input type="hidden" name="dbOldPW" value="<c:out value="${user.password}" />" />
							<table>
								<tr>
									<td>Old Password</td>
									<td>
